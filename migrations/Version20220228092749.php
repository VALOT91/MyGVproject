 ...
 */
final class Version20220228092749 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE delivery_address ADD raison_soc VARCHAR(255) NOT NULL');
        // $this->addSql('DROP INDEX UNIQ_1F452A28F347EFB ON produit_conditionnement');
        $this->addSql('ALTER TABLE produit_conditionnement CHANGE image_path image_path VARCHAR(50) NOT NULL');
