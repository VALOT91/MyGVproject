 ...
 */
final class Version20220224172840 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE command_shop_line (id INT AUTO_INCREMENT NOT NULL, produit_id INT NOT NULL, command_shop_id INT DEFAULT NULL, quantity INT DEFAULT NULL, INDEX IDX_97D71D86F347EFB (produit_id), INDEX IDX_97D71D86A27C973E (command_shop_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        // $this->addSql('ALTER TABLE command_shop_line ADD CONSTRAINT FK_97D71D86F347EFB FOREIGN KEY (produit_id) REFERENCES product (id)');
